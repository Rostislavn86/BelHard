...
// программа должна продемонстрировать как машина едет - т.е. на консоль если машина работает после любого действия должна выводиться ее скорость и номер передачи
